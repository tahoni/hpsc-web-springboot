...
Read and strictly follow **all conventions defined in AGENTS.md** (loaded above) — in particular its **Test Conventions**, **Architecture** and **Build & Run Commands** sections. Treat it as the single source of truth; do not reinterpret or contradict its rules.
