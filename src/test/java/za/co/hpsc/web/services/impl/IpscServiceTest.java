...
public class IpscServiceTest {
    ...
    void testImportWinMssCabFile_withValidCabFile_thenReturnsSuccessResponse() {
        ...
        // Act
        ControllerResponse response = assertDoesNotThrow(() -> ipscService.importWinMssCabFile(cabFileContent));
    ...
    void testImportWinMssCabFile_withNullCabFile_thenThrowsValidationException() {
        // Act & Assert
        assertThrows(ValidationException.class, () -> ipscService.importWinMssCabFile(null));
    }

    @Test
    void testImportWinMssCabFile_withEmptyCabFile_thenThrowsValidationException() {
        // Act & Assert
        assertThrows(ValidationException.class, () -> ipscService.importWinMssCabFile(""));
    }
