...
*/
    ...
    @Test
    void mapMatchOnly_whenMatchResponseIsNull_thenReturnsEmptyOptional() {
        // Act
        Optional<MatchResultsDto> result = transformationService.mapMatchOnly(null);
    ...
    @Test
    void mapMatchOnly_whenValidMatchResponse_thenReturnsMatchResultsDto() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(1);
        matchResponse.setMatchName("Test Match");
        matchResponse.setMatchDate(LocalDateTime.of(2026, 5, 15, 10, 0));
        matchResponse.setClubId(5);

        // Act
        Optional<MatchResultsDto> result = transformationService.mapMatchOnly(matchResponse);
    ...
    @Test
    void mapMatchOnly_whenMatchResponseWithoutClubId_thenCreatesClubResponseWithNullId() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(2);
        matchResponse.setMatchName("No Club Match");
        matchResponse.setMatchDate(LocalDateTime.of(2026, 6, 1, 14, 30));
        matchResponse.setClubId(null);
        ...
        assertTrue(result.isPresent());
        assertNotNull(result.get().getMatch());
        assertEquals("No Club Match", result.get().getMatch().getName());
    }

    @Test
    void mapMatchOnly_whenMatchResponseWithNullName_thenInitializesMatchWithNullName() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(3);
        matchResponse.setMatchName(null);
        matchResponse.setMatchDate(LocalDateTime.of(2026, 7, 10, 9, 0));
    ...
    @Test
    void mapMatchOnly_whenMatchResponseWithMinimalData_thenReturnsPopulatedDto() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(4);
        matchResponse.setMatchDate(LocalDateTime.of(2026, 8, 20, 11, 0));
    ...
    @Test
    void mapMatchOnly_whenMatchResponseWithAllFields_thenInitializesAllMatchFields() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(5);
        matchResponse.setMatchName("Complete Match");
        matchResponse.setMatchDate(LocalDateTime.of(2026, 9, 5, 15, 30));
        matchResponse.setClubId(10);
        matchResponse.setSquadCount(8);
        ...
        // Assert
        assertTrue(result.isPresent());
        MatchResultsDto dto = result.get();
        assertNotNull(dto.getMatch());
        assertEquals("Complete Match", dto.getMatch().getName());
        assertEquals(LocalDateTime.of(2026, 9, 5, 15, 30), dto.getMatch().getScheduledDate());
    }

    @Test
    void mapMatchOnly_whenInvokedMultipleTimesWithDifferentResponses_thenReturnsIndependentResults() {
        // Arrange
        MatchResponse matchResponse1 = new MatchResponse();
        matchResponse1.setMatchId(6);
        matchResponse1.setMatchName("Match A");
        matchResponse1.setMatchDate(LocalDateTime.of(2026, 4, 30, 10, 0));
        matchResponse1.setClubId(1);

        MatchResponse matchResponse2 = new MatchResponse();
        matchResponse2.setMatchId(7);
        matchResponse2.setMatchName("Match B");
        matchResponse2.setMatchDate(LocalDateTime.of(2026, 4, 30, 11, 0));
        matchResponse2.setClubId(2);

        // Act
        Optional<MatchResultsDto> result1 = transformationService.mapMatchOnly(matchResponse1);
        Optional<MatchResultsDto> result2 = transformationService.mapMatchOnly(matchResponse2);

        // Assert
        assertTrue(result1.isPresent());
        assertTrue(result2.isPresent());
        assertEquals("Match A", result1.get().getMatch().getName());
        assertEquals("Match B", result2.get().getMatch().getName());
    }

    @Test
    void mapMatchOnly_returnsOptionalOfMatchResultsDto_notDirectInstance() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(8);
        matchResponse.setMatchName("Type Check Match");
        matchResponse.setMatchDate(LocalDateTime.now());
        ...
        // Assert
        assertTrue(result.isPresent());
        assertInstanceOf(MatchResultsDto.class, result.get());
        assertNotNull(result.get().getMatch());
    }

    @Test
    void mapMatchOnly_whenMatchResponseProvided_thenMatchDtoInitializedWithResponseValues() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(9);
        matchResponse.setMatchName("Initialization Test");
        LocalDateTime testDate = LocalDateTime.of(2026, 5, 20, 13, 45);
        matchResponse.setMatchDate(testDate);
        matchResponse.setClubId(15);
        ...
        assertTrue(result.isPresent());
        assertNotNull(result.get().getMatch());
        assertEquals("Initialization Test", result.get().getMatch().getName());
        assertEquals(testDate, result.get().getMatch().getScheduledDate());
    }

    @Test
    void mapMatchOnly_whenMatchResponseHasZeroClubId_thenHandlesGracefully() {
        // Arrange
        MatchResponse matchResponse = new MatchResponse();
        matchResponse.setMatchId(10);
        matchResponse.setMatchName("Zero Club ID Match");
        matchResponse.setMatchDate(LocalDateTime.of(2026, 10, 1, 12, 0));
        matchResponse.setClubId(0);
