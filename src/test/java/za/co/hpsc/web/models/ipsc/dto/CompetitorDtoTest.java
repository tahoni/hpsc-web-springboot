...
class CompetitorDtoTest {
    ...
    @Test
    void testConstructor_whenMemberResponseNull_thenKeepsDefaults() {
        // Arrange
        CompetitorDto dto = new CompetitorDto((MemberResponse) null);
    ...
    @Test
    void testConstructor_whenMemberResponseFirstNameContainsRoInParentheses_thenRemovesSuffix() {
        // Arrange
        MemberResponse memberResponse = new MemberResponse();
        memberResponse.setMemberId(33);
        memberResponse.setFirstName("Jane (RO)");
        memberResponse.setLastName("Doe");
        memberResponse.setDateOfBirth(LocalDateTime.of(1995, 3, 10, 7, 30));
        memberResponse.setIcsAlias("12345");

        // Act
        CompetitorDto dto = new CompetitorDto(memberResponse);

        // Assert
        assertEquals(33, dto.getIndexes().getFirst());
        assertEquals("Jane", dto.getFirstName());
        assertEquals("Doe", dto.getLastName());
    ...
    @Test
    void testConstructor_whenMemberResponseLastNameHasTrailingRo_thenRemovesSuffix() {
        // Arrange
        MemberResponse memberResponse = new MemberResponse();
        memberResponse.setMemberId(36);
        ...
        // Assert
        assertEquals(36, dto.getIndexes().getFirst());
        assertEquals("Jane", dto.getFirstName());
        assertEquals("Doe", dto.getLastName());
    ...
    @Test
    void testConstructor_whenMemberResponseAliasNonNumeric_thenSetsCompetitorNumberAndNullSapsaNumber() {
        // Arrange
        MemberResponse memberResponse = new MemberResponse();
        memberResponse.setMemberId(34);
        ...
        // Assert
        assertEquals(34, dto.getIndexes().getFirst());
        assertEquals("ABC123", dto.getCompetitorNumber());
        assertNull(dto.getSapsaNumber());
    }

    @Test
    void testConstructor_whenMemberResponseAliasEqualsMaxSapsaNumber_thenSetsSapsaNumber() {
        // Arrange
        MemberResponse memberResponse = new MemberResponse();
        memberResponse.setMemberId(35);
        ...
        // Assert
        assertEquals(35, dto.getIndexes().getFirst());
    ...
    @Test
    void testInit_whenIpscUtilReturnsNullAndExistingSapsaNumberNull_thenKeepsNullForAllInvalidAliasValues() {
        // Arrange
        String[] invalidAliases = {null, "", "   ", "ABC123", "15000", "16000", "1e3", "999999999999"};
        ...
        for (String invalidAlias : invalidAliases) {
            ...
            MemberResponse memberResponse = new MemberResponse();
            memberResponse.setMemberId(27);
            memberResponse.setFirstName("Null");
            memberResponse.setLastName("State");
            memberResponse.setIcsAlias(invalidAlias);

            dto.init(memberResponse);

            assertEquals(invalidAlias, dto.getCompetitorNumber());
            assertNull(dto.getSapsaNumber());
        }
    }

    @Test
    void testInit_whenIpscUtilReturnsNullAndExistingSapsaNumberSet_thenPreservesExistingForAllInvalidAliasValues() {
        // Arrange
        Integer[] existingSapsaNumbers = {0, 1, 43210, IpscConstants.MAX_SAPSA_NUMBER, Integer.MAX_VALUE};
        String[] invalidAliases = {null, "", "   ", "ABC123", "15000", "16000", "1e3", "999999999999"};

        // Act and Assert
        for (Integer existingSapsaNumber : existingSapsaNumbers) {
            for (String invalidAlias : invalidAliases) {
                CompetitorDto dto = new CompetitorDto();
                dto.setSapsaNumber(existingSapsaNumber);

                MemberResponse memberResponse = new MemberResponse();
                memberResponse.setMemberId(28);
                ...
                assertEquals(invalidAlias, dto.getCompetitorNumber());
                assertEquals(existingSapsaNumber, dto.getSapsaNumber());
            }
        }
    }
