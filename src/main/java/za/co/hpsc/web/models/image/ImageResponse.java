...
public class ImageResponse extends Response {
     ...
     *                    a new UUID will be generated by the superclass constructor.
     * @param title       the title of the image. Must not be null or blank.
     * @param summary     a brief summary of the image. Can be null.
     * @param description a detailed description of the image. Can be null.
     * @param category    the category under which the image is classified. Can be null.
